...
public class AdminAddTrain extends JFrame {
    ...
    private void initComponents() {
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                train.setDate(fieldDate.getText());
                train.setPrice(Double.parseDouble(fieldPrice.getText()));
                if (controller.client.addTrain(train)) {
                    AdminHome.display();
                    frame.setVisible(false);
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserFindTrain.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
