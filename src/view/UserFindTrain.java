...
public class UserFindTrain extends JFrame {
    ...
    private void initComponents() {
        ...
        JLabel titleFind = new JLabel("Tìm vé tàu");
        ...
        titleFind.setBounds(468, 130, 156, 35);
        ...
        btnFind.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                List<Train> trains = controller.client.findTrains(fieldfromStation.getText().isEmpty() ? "" : fieldfromStation.getText(), fieldtoStation.getText(), fieldDate.getText().isEmpty() ? "" : fieldtoStation.getText());
                UserChooseTrain.display(trains);
                frame.setVisible(false);
            }
